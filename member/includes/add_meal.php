    ...
    <div class="col-sm-10">
      <div class="form-group">
        ...
        <select class="form-control" name="morning" id="exampleFormControlSelect1">
          <option value="0">Mess Cut</option>
    ...
    <div class="col-sm-10">
      <div class="form-group">
        ...
        <select class="form-control" name="lunch" id="exampleFormControlSelect2">
          <option value="0">Mess Cut</option>
          <option value="30">Normal</option>
          <option value="60">Normal with Fish</option>
          <option value="70">Normal with Chicken</option>
          <option value="70">Biriyani(Special)</option>
        </select>
      </div>
    </div>
  </div>
    ...
    <div class="col-sm-10">
      <div class="form-group">
        ...
        <select class="form-control" name="dinner" id="exampleFormControlSelect3">
          ...
          <option value="90">Normal with Special(Chicken/Beef)</option>
        </select>
      </div>
    </div>
  </div>
